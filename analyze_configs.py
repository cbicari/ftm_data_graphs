...
sns.boxplot(x='config', y='estimated_distance_cm', data=df_150, order=config_order, 
            palette='viridis', showfliers=False)  # showfliers=False hides outliers for clarity
...
plt.legend()
plt.tight_layout()
plt.savefig('configs_boxplot_150cm.png', dpi=150)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('configs_boxplot_300cm.png', dpi=150)
plt.show()

# ============================================================================
# FIGURE 3: Violin plot (shows distribution shape better)
# ============================================================================
...
plt.tight_layout()
plt.savefig('configs_violin_both.png', dpi=150)
plt.show()
